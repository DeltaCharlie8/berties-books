...
CREATE TABLE users (id INT AUTO_INCREMENT,username VARCHAR(20),first_name VARCHAR(20),last_name VARCHAR(20),email VARCHAR(50),hashedPassword VARCHAR(50), PRIMARY KEY(id));
